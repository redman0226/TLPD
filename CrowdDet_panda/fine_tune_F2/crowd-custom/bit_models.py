...
class ResNetV2(nn.Module):
  ...
  def __init__(self, block_units, width_factor, head_size=21843, zero_head= False, non_head = False):
    super().__init__()
